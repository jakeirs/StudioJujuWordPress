...
<!-- /Easy WP Meta Description -->
	...
	function description_meta_box(){
		$id = 'add_description';
		$title =  __( 'Text to display on homepage', 'studiojuju' );
		...
		$builtin_posttypes = array( 'page' );
		$screens = array_merge( $builtin_posttypes );
...
<p><?php 
		_e( 'Add text to display on home page', 'studiojuju' ); ?>. <?php
